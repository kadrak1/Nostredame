...
| # | Вопрос | Решение |
|---|--------|---------|
| 1 | Нужен ли таймер готовки (сколько времени занял кальянщик)? | **Решено: Нет** — в MVP не нужен |
| 2 | Видит ли кальянщик брони или только активные заказы? | **Решено: Нет** — только заказы кальянов (AC-10) |
| 3 | Может ли быть несколько кальянщиков одновременно? | **Решено: Нет** — в MVP один кальянщик |
| 4 | Нужна ли статистика (среднее время готовки) в панели кальянщика? | **Решено: Нет** — в MVP не нужна |
