...
- **US-090-3**: Как кальянщик, я хочу отметить кальян готовым, чтобы гость получил уведомление.
...
- FR-090-12: Кнопка "Подан" (`preparing` → `served`) — карточка исчезает из очереди, гость получает уведомление
