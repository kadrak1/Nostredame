...
- FR-100-02: Блок показывает: крепость, список табаков (без граммовки — не влияет на юзерфлоу гостя), комментарий
...
- FR-100-07: Карточка заказа: дата, номер стола, крепость, состав (только названия табаков, без граммовки), статус
