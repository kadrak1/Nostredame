...
| # | Вопрос | Кто отвечает |
|---|--------|--------------|
| 1 | Нужно ли в будущем добавить SMS-верификацию поверх телефонного входа? | Владелец |
| 2 | Должен ли гостевой JWT истекать при каждом визите или быть постоянным? (предлагаю 7 дней) | Команда |
| 3 | Показывать ли кнопку "Войти" на главной странице или только в процессе бронирования? | UX |
